...
*   If the vibe is **premium consumer, health, luxury, or interactive portfolio** $\rightarrow$ Load [aesthetic-soft-tactile.md](file:///Users/stenalpjolly/github/Experiments/llm-skills/skills/designing-tasteful-frontends/references/aesthetic-soft-tactile.md) (enforces Double-Bezel nested cards, button-in-button CTAs, and spring motion curves).
*   If the vibe is **Notion/Linear-style, clean workspace, documentation, or editorial** $\rightarrow$ Load [aesthetic-minimalist-editorial.md](file:///Users/stenalpjolly/github/Experiments/llm-skills/skills/designing-tasteful-frontends/references/aesthetic-minimalist-editorial.md) (enforces warm bone off-white canvas, spot pastels, ultra-flat 1px borders, and physical keyboard Micro-UIs).
*   If the vibe is **cybernetic, mechanical, aerospace blueprint, raw industrial, or high-density data** $\rightarrow$ Load [aesthetic-industrial-brutalist.md](file:///Users/stenalpjolly/github/Experiments/llm-skills/skills/designing-tasteful-frontends/references/aesthetic-industrial-brutalist.md) (enforces Swiss print, CRT telemetry, absolute-zero corner radius, and ASCII symbols).
*   If the task is **highly visual** and image generation tools are available in the environment $\rightarrow$ Load [workflow-image-to-code.md](file:///Users/stenalpjolly/github/Experiments/llm-skills/skills/designing-tasteful-frontends/references/workflow-image-to-code.md) (enforces the image $\rightarrow$ analyze $\rightarrow$ code pipeline).
...
Unless the brief maps to an official enterprise design system (see [design-systems.md](file:///Users/stenalpjolly/github/Experiments/llm-skills/skills/designing-tasteful-frontends/references/design-systems.md)), use these default conventions:
...
*   **[ai-tells.md](file:///Users/stenalpjolly/github/Experiments/llm-skills/skills/designing-tasteful-frontends/references/ai-tells.md):** Complete catalog of banned AI visual, layout, and copywriting patterns (including the **Em-Dash Ban**).
*   **[visual-vocabulary.md](file:///Users/stenalpjolly/github/Experiments/llm-skills/skills/designing-tasteful-frontends/references/visual-vocabulary.md):** Architectural patterns for Hero sections, Bento grids, and components.
*   **[design-systems.md](file:///Users/stenalpjolly/github/Experiments/llm-skills/skills/designing-tasteful-frontends/references/design-systems.md):** Setup guide for official enterprise systems (Material Web, Fluent UI, Carbon, Primer, etc.).
*   **[aesthetic-soft-tactile.md](file:///Users/stenalpjolly/github/Experiments/llm-skills/skills/designing-tasteful-frontends/references/aesthetic-soft-tactile.md):** Luxury/spring motion/nested cards double-bezel aesthetic.
