...
*   See detailed protocol at [code-review-reception.md](references/code-review-reception.md).
...
*   See detailed protocol at [requesting-code-review.md](references/requesting-code-review.md).
*   Request review after EACH task in subagent-driven development.

### Verification Gates Protocol
*   See detailed protocol at [verification-before-completion.md](references/verification-before-completion.md).
