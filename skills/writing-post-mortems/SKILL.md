...
For the up-the-org version of this same content, hand the finished post-mortem to [`translating-for-management`](../translating-for-management/SKILL.md). They compose: post-mortem owns the engineering truth, management-talk reframes it for leadership.
...
- **Next Step Hooks:** Always conclude the post-mortem by asking the user if they'd like a leadership summary via [`translating-for-management`](../translating-for-management/SKILL.md).
