...
- Escalate to a full Skill (`skills/<subcategory>/<skill-name>/SKILL.md`) only for multi-step processes or reproducible methodologies.
...
1. Create a gerund-named directory: `skills/<subcategory>/<gerund-name>/`.
